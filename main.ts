...
controller.up.onEvent(ControllerButtonEvent.Pressed, function () {
    if (game_mode == 1) {
        ...
        if (hero_saitama.vy == 0) {
            hero_saitama.vy = randint(-185, -190)
        }
    } else {
...
sprites.onOverlap(SpriteKind.animal2, SpriteKind.Player, function (sprite, otherSprite) {
    if (touched2 == false) {
        animal_2.sayText(":)", 2000, true)
        pause(2000)
        animal_2.sayText("I am", 2000, true)
        pause(2000)
        animal_2.sayText("A", 2000, true)
        pause(2000)
        story.spriteSayText(animal_2, "Monkey", 15, 1, story.TextSpeed.VerySlow)
        story.spriteSayText(animal_2, "Check out Others", 15, 1, story.TextSpeed.VerySlow)
        story.spriteSayText(animal_2, "They can't wait to meet u", 15, 1, story.TextSpeed.VerySlow)
        animals_met += 1
        touched2 = true
    }
})
