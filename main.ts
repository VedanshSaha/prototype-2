...
namespace SpriteKind {
    ...
    export const snaky = SpriteKind.create()
    export const bat = SpriteKind.create()
    export const caml = SpriteKind.create()
    export const dor = SpriteKind.create()
}
function screen_1 () {
    ...
    game.setDialogCursor(img`
        ...
        ........................
        `)
    game.showLongText("Ooh Wow! So cute plants and animals here! But which biome is it?                            \"A\" or Space To Continue", DialogLayout.Full)
    game.setDialogCursor(assets.image`Camel`)
    game.showLongText("Are you new here? This is one of the most famous biome in the world... DESERT! probably because I live here.                            \"A\" or Space To Continue", DialogLayout.Full)
    game.setDialogCursor(img`
        ........................
        .....ffff...............
        ...fff22fff.............
        ...
        ........................
        `)
    game.showLongText("But who are you?                            \"A\" or Space To Continue", DialogLayout.Full)
    game.setDialogCursor(assets.image`Camel`)
    game.showLongText("I won't tell now come and meet my friends... we'll introduce ourselves... but I think I am really famous.                             \"A\" or Space To Play ", DialogLayout.Full)
    aebc = 1
    t1 = false
    t2 = false
    t3 = false
    animals_met = 0
    snaky = sprites.create(assets.image`myImage3`, SpriteKind.snaky)
    snaky.setPosition(280, 296)
    batty = sprites.create(assets.image`myImage3`, SpriteKind.bat)
    batty.setPosition(605, 185)
    camel = sprites.create(assets.image`myImage3`, SpriteKind.caml)
    camel.setPosition(843, 312)
    d1 = sprites.create(assets.image`Door`, SpriteKind.dor)
    d1.setPosition(927, 296)
    ...
    sprites.destroyAllSpritesOfKind(SpriteKind.animal1)
    sprites.destroyAllSpritesOfKind(SpriteKind.animal2)
    sprites.destroyAllSpritesOfKind(SpriteKind.animaal3)
    sprites.destroyAllSpritesOfKind(SpriteKind.animaal4)
    sprites.destroyAllSpritesOfKind(SpriteKind.animaal5)
    sprites.destroyAllSpritesOfKind(SpriteKind.door)
    hero_saitama.setPosition(50, 50)
...
sprites.onOverlap(SpriteKind.dor, SpriteKind.Player, function (sprite, otherSprite) {
    if (animals_met == 3) {
        screen_3()
    }
})
...
function screen_3 () {
    aebc = 1
    sprites.destroyAllSpritesOfKind(SpriteKind.snaky)
    sprites.destroyAllSpritesOfKind(SpriteKind.bat)
    sprites.destroyAllSpritesOfKind(SpriteKind.caml)
    sprites.destroyAllSpritesOfKind(SpriteKind.dor)
    hero_saitama.setPosition(50, 50)
...
sprites.onOverlap(SpriteKind.caml, SpriteKind.Player, function (sprite, otherSprite) {
    if (t3 == false) {
        game.setDialogCursor(img`
            ........................
            .....ffff...............
            ...
            ........................
            `)
        game.showLongText("Yay! I found you. I even know your name now.", DialogLayout.Bottom)
        game.setDialogCursor(assets.image`Camel`)
        game.showLongText("How? That's Impossible ", DialogLayout.Bottom)
        game.setDialogCursor(img`
            ........................
            .....ffff...............
            ...fff22fff.............
            ...
            ........................
            `)
        game.showLongText("Mr. Common Vampire Bat told me", DialogLayout.Bottom)
        game.setDialogCursor(assets.image`Camel`)
        game.showLongText("Oh right and did he tell you that us camels are killed for meat by humans :<", DialogLayout.Bottom)
        game.setDialogCursor(img`
            ........................
            .....ffff...............
            ...fff22fff.............
            ...
            ........................
            `)
        game.showLongText("Uh! I am really sorry to hear this. I sure will try to do something about it when I get home", DialogLayout.Bottom)
        game.setDialogCursor(assets.image`Camel`)
        game.showLongText("Better do it. Thanks.. Bye!", DialogLayout.Bottom)
        animals_met += 1
        t3 = true
    }
})
sprites.onOverlap(SpriteKind.snaky, SpriteKind.Player, function (sprite, otherSprite) {
    if (t1 == false) {
        game.setDialogCursor(img`
            ........................
            .....ffff...............
            ...
            ........................
            `)
        game.showLongText("Hey Hi! What are you?. I mean who are you?", DialogLayout.Bottom)
        game.setDialogCursor(img`
            . . . f f f f f f . . . . . . . 
            . . f e e e e e e f . . . . . . 
            . f e e e e e e e e f . . . . . 
            ...
            . . . f f f f f f f f f f . . . 
            `)
        game.showLongText("Huh? Don't you know me, I am Sand Viper - A snake", DialogLayout.Bottom)
        game.setDialogCursor(img`
            ........................
            .....ffff...............
            ...fff22fff.............
            ...
            ........................
            `)
        game.showLongText("Oh! right. Can you pls tell me where that double humped creature went.", DialogLayout.Bottom)
        game.setDialogCursor(img`
            . . . f f f f f f . . . . . . . 
            . . f e e e e e e f . . . . . . 
            . f e e e e e e e e f . . . . . 
            ...
            . . . f f f f f f f f f f . . . 
            `)
        game.showLongText("He is further ahead. Nice to meet you. Bye!", DialogLayout.Bottom)
        animals_met += 1
        t1 = true
    }
})
...
sprites.onOverlap(SpriteKind.bat, SpriteKind.Player, function (sprite, otherSprite) {
    if (t2 == false) {
        game.setDialogCursor(img`
            ...
            ........................
            `)
        game.showLongText("Hey Hi! Are you a sand viper?", DialogLayout.Bottom)
        game.setDialogCursor(img`
            .fff........fff.........
            ffc.......fcbbc.........
            fcc......fcbbc..........
            ...
            ...fffffff..............
            `)
        game.showLongText("What are you talking about? I am Desmodus rotundus - Common bat", DialogLayout.Bottom)
        game.setDialogCursor(img`
            ........................
            .....ffff...............
            ...fff22fff.............
            ...
            ........................
            `)
        game.showLongText("Oh! ok. if you could tell me where", DialogLayout.Bottom)
        game.setDialogCursor(img`
            .fff........fff.........
            ffc.......fcbbc.........
            fcc......fcbbc..........
            ...
            ...fffffff..............
            `)
        game.showLongText("where bactrian camel is? he is just ahead, near the teleportation gate. :D", DialogLayout.Bottom)
        animals_met += 1
        t2 = true
    }
})
...
function screen_2 () {
    if (game_mode == 2) {
        ...
        game.setDialogFrame(img`
            ...
            7 f 7 7 f f f 7 f f f f f f f f 
            7 7 f f f f f f 7 f 7 f f f f 7 
            f f 7 f f f f f f 7 f f f f f 7 
            f f f f 7 7 f f f f f f 7 7 f 7 
            f f f f f f f f f f f 7 f f 7 7 
            f f f f f f f f 7 f f f 7 f f 7 
            f f f 7 f f f f f 7 7 7 7 7 f 7 
            f f 7 f f f f f f f 7 7 7 7 f 7 
            f f f f f 7 f f f f 7 7 7 7 f 7 
            f f f f f 7 f f f f 7 7 7 7 f 7 
            f f f f 7 f f 7 7 7 7 7 7 7 f 7 
            f f 7 f 7 7 7 f f f 7 7 7 7 f 7 
        ...
        game.showLongText("Hi! I am going on a world tour will you accompany me.... Thanks. So The first stop is Amazon!                            \"A\" or Space for Next", DialogLayout.Full)
        game.showLongText("I have to meet pigeon, monkey, lion, cherry blossom and wolf...                            \"A\" or Space for Next", DialogLayout.Full)
        game.showLongText("Use controller to move                            \"A\" or Space To Play", DialogLayout.Full)
        touched1 = false
        touched2 = false
        touched_3 = false
        touched4 = false
        ...
        animal_4 = sprites.create(img`
            .....39....393....93..3.....33..
            ..9.99999.933339..399.3..3393...
            ..93333.969313.3dd3333dd339e333.
            ...1339.33333313d33d3d33d313333.
            99.393.33136333333333333c33133..
            3e91913333333d99d333d333333133.3
            ..333933333339dddd333d933333d33.
            .9.31939333399133333331333dd3dd.
            .111163133131333313333313333d3d3
            ..133.33333d333333139333133d3dd3
            ..33d3dd3333dd333333933333331333
            3dddd33dd.3d13333333133333991.dd
            .dd33331131333133133d3313113133.
            .d31333333331313313dd3333313....
            .d333333.33933333133d333331333.d
            d..333333.33333333331313333311..
            d.dd3...33333333311331333333.11.
            ..ddd.3333.33.3d1313cc333331131.
            ...3...31333.3331311d3333333331.
            .....33....3.dd33e311d.d...ddd..
            .....d3....33dd111313..d.d......
            .....d..........4eeee.d.........
            ................4deed...........
            ................4eeec...........
        ...
        controller.moveSprite(hero_saitama, 100, 100)
...
forever(function () {
    if (game_mode == 2) {
        if (aebc == 0) {
            ...
            rem.setText("Remaining:" + convertToText(3 - animals_met))
            rem.setPosition(hero_saitama.x, hero_saitama.y - 50)
        } else {
...
forever(function () {
    if (game_mode == 2) {
        if (hero_saitama.y == 376) {
            ...
            animals_met = 0
            hero_saitama.setPosition(50, 50)
            game.showLongText("Restart                            \"A\" or Space To Play", DialogLayout.Full)
        } else {
